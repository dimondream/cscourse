...
class BinarySearchTree:
    ...
    def maximum(self) -> Optional[int]:
        ...
        if self.is_empty():
            return None
        elif self._right._root is not None:
            return self._right.maximum()
        elif self._left._root is not None:
    ...
    def items(self) -> list[Any]:
        ...
        if self.is_empty():
            ...
            item = [self._root]
            item = self._left.items() + item
            item += self._right.items()
            return item
    ...
    def smaller(self, item: Any) -> list[Any]:
        ...
        #        return [self._root]
            ...
            if self._root < item:
                lst = [self._root]
                lst = self._left.smaller(item) + lst
                lst += self._right.smaller(item)
            else:
