...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        """
        for number in self._phone_lines:
            if number.get_number() == call.src_number:
                number.make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        """
        for number in self._phone_lines:
            number.callhistory.register_incoming_call(call)
            number.receive_call(call)
